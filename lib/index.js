...
const Canvas = _ref => {
  ...
  const {
    ...
    handleTextChange,
    textboxes
  } = annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji ? emojiHook : annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.circle ? circleHook : annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textbox ? textBoxHook : drawHook;
...
function useOnCircle(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    console.log('circle ctx', ctx, canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current);
    setCanvasCtx(ctx);
...
function useOnDraw(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    parentCanvasRef.current = canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current;
    console.log('draw ctx', ctx, canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current);
    setCanvasCtx(ctx);
    function initMouseMoveListener() {
      const mouseMoveListener = e => {
        if (isDrawingRef.current) {
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onDraw, channel, otherProps.isCanvasClear, otherProps.isImageSaved, otherProps.lineColor, otherProps]);
  function setCanvasRef(ref) {
    if (!ref) return;
    canvasRef.current = ref;
  }
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    parentCanvasRef.current = canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current;
    console.log('emoji ctx', ctx, canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current);
    setCanvasCtx(ctx);
    setAnnotations([...annotations]);
    if (props.isCanvasClear) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearCanvas)(ctx, props.width, props.height);
    }
  }, [channel, otherProps.isCanvasClear, setCanvasCtx, otherProps, annotations === null || annotations === void 0 ? void 0 : annotations.length]);
...
function useOnTextBox(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    parentCanvasRef.current = canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current;
    console.log('text ctx', ctx, canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current);
    setCanvasCtx(ctx);
    setAnnotations([...annotations]);
    if (props.isCanvasClear) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearCanvas)(ctx, props.width, props.height);
