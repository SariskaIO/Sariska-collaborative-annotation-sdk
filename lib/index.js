...
const Canvas = _ref => {
  ...
  let drawnTextboxes = (annotations === null || annotations === void 0 ? void 0 : annotations.length) && (annotations === null || annotations === void 0 ? void 0 : annotations.filter(annotation => annotation.type === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textbox.toLowerCase()));
