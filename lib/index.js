...
const Canvas = _ref => {
  ...
  const {
    setCanvasRef,
    onMouseDown
  } = (0,_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_1__.useOnDraw)(pushMessage, channel, setCanvasCtx);
...
const StoreProvider = _ref => {
  ...
  return /*#__PURE__*/React.createElement(_StoreContext__WEBPACK_IMPORTED_MODULE_3__["default"].Provider, {
    value: {
      users: state.users,
      rooms: state.rooms,
      dispatch
...
function useOnDraw(pushMessage, channel, setCanvasCtx) {
...
const SariskaCollaborativeAnnotation = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_context_store_StoreProvider__WEBPACK_IMPORTED_MODULE_4__.StoreProvider, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_context_socket_SocketProvider__WEBPACK_IMPORTED_MODULE_3__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_App__WEBPACK_IMPORTED_MODULE_2__["default"], null))));
};
