...
const App = props => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_DrawingBoard__WEBPACK_IMPORTED_MODULE_5__["default"], {
    inputProps: props,
    messages: messages,
...
const Canvas = _ref => {
  ...
  const {
    setCanvasRef,
    onMouseDown
  } = annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji ? emojiHook : drawHook;
  const canvasStyle = {
    position: 'absolute',
...
function onDraw(data) {
  var _data$otherProps, _data$otherProps2;
  drawLine(data.ctx, data.point, data.prevPoint, data === null || data === void 0 || (_data$otherProps = data.otherProps) === null || _data$otherProps === void 0 ? void 0 : _data$otherProps.lineColor, data === null || data === void 0 || (_data$otherProps2 = data.otherProps) === null || _data$otherProps2 === void 0 ? void 0 : _data$otherProps2.lineWidth);
}
