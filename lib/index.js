...
const Canvas = _ref => {
  ...
  const emojiHook = (0,_hooks_useOnEmoji__WEBPACK_IMPORTED_MODULE_3__.useOnEmoji)(pushMessage, channel, setCanvasCtx, otherProps);
  const circleHook = (0,_hooks_useOnCircle__WEBPACK_IMPORTED_MODULE_4__.useOnCircle)(pushMessage, channel, setCanvasCtx, otherProps);
  const drawHook = (0,_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_1__.useOnDraw)(pushMessage, channel, setCanvasCtx, otherProps);

  // Use logic to select the correct hook result
  const {
    setCanvasRef,
    onMouseDown
  } = annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji ? emojiHook : annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.circle ? circleHook : drawHook;
  const canvasStyle = {
    position: 'absolute',
...
function useOnCircle(pushMessage, channel, setCanvasCtx, otherProps) {
    ...
    function initMouseMoveListener() {
      ...
      const mouseMoveListener = e => {
        ...
        if (isDrawingRef.current) {
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_1__.redrawCircles)({
            ctx,
            circles,
            props
          });
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onDrawCircle, channel, otherProps.isCanvasClear, otherProps.isImageSaved, otherProps.lineColor, otherProps]);
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, otherProps) {
  ...
  }, [channel, otherProps.isCanvasClear, setCanvasCtx, otherProps]);
...
/* harmony export */   redrawCircles: () => (/* binding */ redrawCircles),
