...
const App = props => {
  ...
  (0,_hooks_UseEventHandler__WEBPACK_IMPORTED_MODULE_4__["default"])(rtcChannel, 'archived_message', setLoading, message => {
    ...
    let content = JSON.parse(message.content);
    if (content !== null && content !== void 0 && content.ctx && (_Object$keys2 = Object.keys(content === null || content === void 0 ? void 0 : content.ctx)) !== null && _Object$keys2 !== void 0 && _Object$keys2.length) {
      if (props.annotationTool === _constants__WEBPACK_IMPORTED_MODULE_12__.ANNOTATION_TOOLS.emoji) {
...
/* harmony import */ var _hooks_useOnEmoji__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../hooks/useOnEmoji */ "./src/hooks/useOnEmoji.js");
...
const Canvas = _ref => {
  ...
  const emojiHook = (0,_hooks_useOnEmoji__WEBPACK_IMPORTED_MODULE_2__.useOnEmoji)(pushMessage, channel, setCanvasCtx, otherProps);
  ...
  //annotationTool === ANNOTATION_TOOLS.emoji ? 
  emojiHook;
  //: drawHook;
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, otherProps) {
  ...
  }, [channel, otherProps.isCanvasClear]);
