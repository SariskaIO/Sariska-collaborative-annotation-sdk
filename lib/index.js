...
/* harmony import */ var _hooks_useSticker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hooks/useSticker */ "./src/hooks/useSticker.js");
...
const App = props => {
  ...
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_12__.useSticker)(pushMessage, rtcChannel); // Use emoji hook
  const emojiPositions = _hooks_useSticker__WEBPACK_IMPORTED_MODULE_12__.useSticker.emojiPositions; // Access emoji positions from useEmoji
  ...
  const handleSendEmoji = () => {
    ...
    const canvasWidth = _components_DrawingBoard__WEBPACK_IMPORTED_MODULE_5__["default"].getCanvasWidth();
    const canvasHeight = _components_DrawingBoard__WEBPACK_IMPORTED_MODULE_5__["default"].getCanvasHeight();
    ...
    const emojiData = {
      ...
      position: {
        x: emojiPositions[emojiPositions.length - 1].position.x / canvasWidth * 100,
        // Percentage for network transmission
...
/* harmony import */ var _hooks_useSticker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../hooks/useSticker */ "./src/hooks/useSticker.js");
...
const Canvas = _ref => {
  ...
  } = (0,_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_1__.useOnDraw)(pushMessage, channel, setCanvasCtx, otherProps);
  const {
    handleStickerMouseDown,
    handleStickerMouseMove,
    handleStickerMouseUp,
    emojiPositions
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_2__.useSticker)(pushMessage, channel);
  const canvasStyle = {
    position: 'absolute',
...
/* harmony import */ var _hooks_useSticker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../hooks/useSticker */ "./src/hooks/useSticker.js");
...
const DrawingBoard = _ref => {
  ...
  const {
    ...
    onMouseDown,
    emojiPositions
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_3__.useSticker)(pushMessage, channel);
...
function useSticker(pushMessage, channel) {
  const [selectedEmoji, setSelectedEmoji] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
  const emojiPositions = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]); // Array to store emoji positions
  ...
  const onMouseDown = e => {
    ...
    const clearAllStickers = () => {
      ...
      if (ctx) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clearCanvas)(ctx, canvasRef.current.width, canvasRef.current.height);
      }
    };
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.onEmojiPlace)({
      ctx,
      point,
      emoji: selectedEmoji
    });
...
/* harmony export */   clearStickers: () => (/* binding */ clearStickers),
...
/* harmony export */   onEmojiPlace: () => (/* binding */ onEmojiPlace),
...
function onEmojiPlace(ctx, emoji, position) {
...
function clearStickers(setEmojiPositions) {
  setEmojiPositions([]);
}
