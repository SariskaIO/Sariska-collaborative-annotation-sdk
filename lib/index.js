...
/* harmony import */ var _hooks_useOnTextBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../hooks/useOnTextBox */ "./src/hooks/useOnTextBox.js");
...
const Canvas = _ref => {
  ...
  const textBoxHook = (0,_hooks_useOnTextBox__WEBPACK_IMPORTED_MODULE_3__.useOnTextBox)(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps);
  ...
  annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textBox ? textBoxHook : drawHook;
  ...
  }), textboxes !== null && textboxes !== void 0 && textboxes.length ? textboxes === null || textboxes === void 0 ? void 0 : textboxes.map(textbox => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("textarea", {
    key: textbox.id,
    style: {
      position: 'absolute',
      top: textbox.y + 'px',
