...
const Canvas = _ref => {
  ...
  const getHook = tool => {
    switch (tool) {
      case _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji:
        return _hooks_useOnEmoji__WEBPACK_IMPORTED_MODULE_3__.useOnEmoji;
      case _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.circle:
        return _hooks_useOnCircle__WEBPACK_IMPORTED_MODULE_4__.useOnCircle;
      case _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textbox:
        return _hooks_useOnTextBox__WEBPACK_IMPORTED_MODULE_5__.useOnTextBox;
      default:
        return _hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_1__.useOnDraw;
    }
  };
  ...
  const {
    ...
    handleTextChange,
    textboxes
  } = useAnnotationHook(inputProps.annotationTool, pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps);
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (canvas) {
      ...
      if (annotations && (annotations === null || annotations === void 0 ? void 0 : annotations.length) !== 0) {
