...
const App = props => {
  ...
  (0,_hooks_UseEventHandler__WEBPACK_IMPORTED_MODULE_3__["default"])(rtcChannel, 'new_message', setLoading, message => {
    ...
    if (content?.ctx && Object.keys(content?.ctx)?.length) {
      if (props.annotationTool === _constants__WEBPACK_IMPORTED_MODULE_10__.ANNOTATION_TOOLS.pen) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_9__.onDraw)(content);
      } else if (props.annotationTool === _constants__WEBPACK_IMPORTED_MODULE_10__.ANNOTATION_TOOLS.circle) {
        content.props = {
          width: props.width,
          height: props.height
        };
        (0,_utils__WEBPACK_IMPORTED_MODULE_9__.onDrawCircle)(content);
      } else if (props.annotationTool === _constants__WEBPACK_IMPORTED_MODULE_10__.ANNOTATION_TOOLS.textbox) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_9__.setAllRemoteTextBoxes)(content, remoteTextboxes, setRemoteTextboxes);
      } else {
        content.emojis = [...messages];
        (0,_utils__WEBPACK_IMPORTED_MODULE_9__.onDrawEmoji)(content);
      }
    } else {
...
const Annotation = _ref => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleResize = () => {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, 'currentCircle', annotation); // Redraw existing drawings based on new size
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, 'pen', annotation);
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, 'circle', annotation);
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, 'emoji', annotation);
    };
  ...
  const startDrawing = e => {
    if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.pen) {
      ...
      const {
        offsetX,
        offsetY
      } = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getCanvasPosition)(e);
      const canvas = canvasRef.current;
  ...
  const draw = e => {
    ...
    if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.pen && drawing) {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(canvasCtx, canvasRef, 'currentCircle', annotation); // Redraw everything on each mouse move to update the circle
    }
  };
  const stopDrawing = () => {
    if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.pen && drawing) {
  ...
  const placeEmoji = e => {
    ...
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(canvasCtx, canvasRef, 'emoji', annotation); // Redraw to immediately show the emoji
  };
...
/* harmony import */ var _hooks_useOnTextBox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../hooks/useOnTextBox */ "./src/hooks/useOnTextBox.js");
/* harmony import */ var _Annotation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Annotation */ "./src/components/Annotation/index.js");
...
const Canvas = _ref => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Annotation__WEBPACK_IMPORTED_MODULE_6__["default"], {
    canvasRef: canvasRef,
...
function useOnCircle(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (otherProps.annotationTool !== _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.circle) {
      return;
    }
    ...
    function initMouseMoveListener() {
      const mouseMoveListener = e => {
        if (isDrawingRef.current) {
          const currentPoint = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(e.clientX, e.clientY, canvasRef?.current);
    ...
    function initMouseUpListener() {
      const mouseUpListener = event => {
        if (isDrawingRef.current) {
          const currentPoint = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(event.clientX, event.clientY, canvasRef?.current);
          const startPoint = startPointRef.current;
          const radius = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.calculateCircleRadius)(startPoint, currentPoint);
          setCircles([...circles, {
            center: startPoint,
  ...
  }, [canvasRef, _utils__WEBPACK_IMPORTED_MODULE_1__.onDrawCircle, channel, circles, otherProps, setCanvasCtx, annotations?.length]);
  ...
  function onMouseDown(e) {
    ...
    const point = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(e.clientX, e.clientY, canvasRef?.current);
...
function useOnDraw(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  const handleResize = () => {
    ...
    const scaleX = newWidth / canvasSize.width;
    const scaleY = newHeight / canvasSize.height;
    const scaledPaths = paths.map(path => path.map(_ref => {
      let [x, y] = _ref;
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (otherProps.annotationTool !== _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.pen) {
      return;
    }
    const ctx = canvasRef?.current?.getContext('2d');
    const {
  ...
  }, [canvasRef, _utils__WEBPACK_IMPORTED_MODULE_1__.onDraw, channel,
  //   otherProps.isCanvasClear,
  //  otherProps.isImageSaved,
  //  otherProps.lineColor,
  otherProps, setCanvasCtx, annotations?.length]);
  function setCanvasRef(ref) {
    if (!ref) return;
    canvasRef.current = ref;
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  const setCanvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(ref => {
    if (otherProps.annotationTool !== _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji) {
      return;
    }
    if (!ref) return;
    canvasRef.current = ref;
  ...
  // otherProps,
  //  isCanvasClear
  setCanvasCtx, annotations?.length]);
  const onMouseDown = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(event => {
    ...
    const point = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(event.clientX, event.clientY, canvasRef?.current);
    setEmojis(prevEmojis => [...prevEmojis, {
      ctx,
      point,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useOnTextBox: () => (/* binding */ useOnTextBox)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./src/utils/index.js");
...
function useOnTextBox(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  const [textboxes, setTextboxes] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const canvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (otherProps.annotationTool !== _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textbox) {
      return;
    }
    const ctx = canvasRef?.current?.getContext('2d');
    const {
  ...
  //  otherProps.isCanvasClear,
  setCanvasCtx, otherProps.annotationTool
  // setAnnotations,
  // annotations?.length
  ]);
  ...
  const handleTextChange = (e, id) => {
    ...
    setTextboxes(prevTextboxes => prevTextboxes.map(textbox => {
      if (textbox.id === id) {
        const textMetrics = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.measureText)(newText, textbox.width, canvasRef);
...
const redraw = (context, canvasRef, type, annotation) => {
  ...
  if (type === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.circle) {
    // Redraw circles
    annotationByType.forEach(item => {
      if (item?.circle) {
  ...
  if (type === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.emoji) {
    // Redraw emojis
    annotationByType.forEach(item => {
      if (item.emoji) {
