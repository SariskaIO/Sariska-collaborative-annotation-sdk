...
const App = props => {
  ...
  const {
    setSelectedEmoji,
    positions
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_12__.useSticker)(pushMessage, rtcChannel, setCanvasCtx, {
...
const Canvas = _ref => {
  ...
  const {
    toggleEmoji
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_2__.useSticker)(pushMessage, channel, setCanvasCtx, otherProps);
  const canvasStyle = {
    position: 'absolute',
    zIndex: otherProps.zIndex,
    background: 'none'
...
function useSticker(pushMessage, channel, setCanvasCtx, otherProps) {
  ...
  const [selectedEmoji, setSelectedEmoji] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const canvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const prevPointRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
        ...
        if (emoji) {
          if (isStickRef.current) {
            ...
            if (_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker) {
              (0,_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker)({
                ctx,
                newEmojiPosition,
                prevPosition,
                props
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker, channel, otherProps.isCanvasClear]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (emoji) {
...
function onSticker(ctx, sticker, position) {
