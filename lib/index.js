...
function useOnCircle(pushMessage, channel, setCanvasCtx, annotations, otherProps) {
  ...
  function onMouseDown(e) {
    ...
    const ctx = canvasRef === null || canvasRef === void 0 ? void 0 : canvasRef.current.getContext('2d');
...
function useOnDraw(pushMessage, channel, setCanvasCtx, setAnnotations, otherProps) {
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, setAnnotations, otherProps) {
