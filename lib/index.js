...
const App = props => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleResize = () => {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_9__.redraw)(context, canvasRef, paths, circles, emojis, currentCircle); // Redraw existing drawings based on new size
    };
...
const Annotation = _ref => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleResize = () => {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, paths, circles, emojis, currentCircle); // Redraw existing drawings based on new size
    };
    window.addEventListener('resize', handleResize);
    handleResize(); // Set initial canvas size
