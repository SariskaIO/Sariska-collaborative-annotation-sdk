...
const Canvas = _ref => {
  ...
  const {
    ...
    handleTextChange,
    textboxes
  } = annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.emoji ? emojiHook : annotationTool === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.circle ? circleHook :
