...
function useOnDraw(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    var _canvasRef$current;
    console.log('ANNOTATION_TOOLS.pen', otherProps.annotationTool, _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.pen);
    if (otherProps.annotationTool !== _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.pen) {
      return;
    }
    console.log('retANNOTATION_TOOLS.pen', otherProps.annotationTool, _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.pen);
    const ctx = canvasRef === null || canvasRef === void 0 || (_canvasRef$current = canvasRef.current) === null || _canvasRef$current === void 0 ? void 0 : _canvasRef$current.getContext('2d');
    const {
      parentCanvasRef,
      ...props
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  }, [emojis === null || emojis === void 0 ? void 0 : emojis.length, channel, otherProps, setEmojis, setAnnotations]);
