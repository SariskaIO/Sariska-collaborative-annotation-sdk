...
function useSticker(pushMessage, channel) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    function handleScreenClick(e) {
      if (showEmoji && selectedEmojiRef.current) {
        const point = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(e.clientX, e.clientY);
        const ctx = canvasRef.current.getContext("2d");
        const newEmoji = {
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker, showEmoji, isCanvasClear, pushMessage, channel]);
  function enableEmoji() {
    setShowEmoji(true);
  }
  function disableEmoji() {
...
function onSticker(stickerdata) {
  const {
    ctx,
    point,
    emoji
