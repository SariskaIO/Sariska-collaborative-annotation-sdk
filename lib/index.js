...
const App = props => {
  ...
  (0,_hooks_UseEventHandler__WEBPACK_IMPORTED_MODULE_4__["default"])(rtcChannel, 'new_message', setLoading, message => {
    ...
    if (content !== null && content !== void 0 && content.ctx && (_Object$keys = Object.keys(content === null || content === void 0 ? void 0 : content.ctx)) !== null && _Object$keys !== void 0 && _Object$keys.length) {
      ...
      } else if (props.annotationTool === _constants__WEBPACK_IMPORTED_MODULE_12__.ANNOTATION_TOOLS.textbox) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_10__.setAllRemoteTextBoxes)(content, remoteTextboxes, setRemoteTextboxes);
      } else {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_DrawingBoard__WEBPACK_IMPORTED_MODULE_5__["default"], {
    inputProps: props,
...
const Canvas = _ref => {
  ...
  let drawnTextboxes = (annotations === null || annotations === void 0 ? void 0 : annotations.length) && (annotations === null || annotations === void 0 || (_annotations$filter = annotations.filter(annotation => annotation.type === _constants__WEBPACK_IMPORTED_MODULE_2__.ANNOTATION_TOOLS.textbox.toLowerCase())) === null || _annotations$filter === void 0 ? void 0 : _annotations$filter.map(annotation => annotation.textbox));
  let textboxList = textboxes !== null && textboxes !== void 0 && textboxes.length ? textboxes : remoteTextboxes !== null && remoteTextboxes !== void 0 && remoteTextboxes.length ? remoteTextboxes : drawnTextboxes !== null && drawnTextboxes !== void 0 && drawnTextboxes.length ? drawnTextboxes : [];
  console.log('textboxList', textboxList, drawnTextboxes);
...
function useOnCircle(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  }, [canvasRef, _utils__WEBPACK_IMPORTED_MODULE_1__.onDrawCircle, channel, circles, otherProps, setCanvasCtx, annotations === null || annotations === void 0 ? void 0 : annotations.length]);
...
function useOnDraw(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  otherProps, setCanvasCtx, annotations === null || annotations === void 0 ? void 0 : annotations.length]);
  function setCanvasRef(ref) {
    if (!ref) return;
    canvasRef.current = ref;
  }
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  }, [emojis === null || emojis === void 0 ? void 0 : emojis.length, channel, otherProps, setAnnotations]);
...
function useOnTextBox(pushMessage, channel, setCanvasCtx, annotations, setAnnotations, otherProps) {
  ...
  setCanvasCtx,
  //  otherProps,
  setAnnotations, annotations === null || annotations === void 0 ? void 0 : annotations.length]);
  ...
  const handleTextChange = (e, id) => {
    ...
    const ctx = canvasRef === null || canvasRef === void 0 || (_canvasRef$current3 = canvasRef.current) === null || _canvasRef$current3 === void 0 ? void 0 : _canvasRef$current3.getContext('2d');
    setTextboxes(prevTextboxes => prevTextboxes.map(textbox => {
      if (textbox.id === id) {
        ...
        setAnnotations(annotations => annotations.map(annotation => {
          var _annotation$textbox;
          return ((_annotation$textbox = annotation.textbox) === null || _annotation$textbox === void 0 ? void 0 : _annotation$textbox.id) === id ? {
            ...annotation,
            textbox: newTextbox
          } : annotation;
        }));
