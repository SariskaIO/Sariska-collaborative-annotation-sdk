...
const App = props => {
  ...
  const {
    ...
    selectEmoji,
    isEmojiEnabled
  } = useSticker(pushMessage, rtcChannel);
  return (
    /*#__PURE__*/
    // <>
    //   {
    ...
    //       :
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      onClick: onHandleClick
    }, isEmojiEnabled ? 'Disable Emoji' : 'Enable Emoji'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_DrawingBoard__WEBPACK_IMPORTED_MODULE_5__["default"], {
      inputProps: props,
...
const Canvas = _ref => {
  ...
  const {
    ...
    selectEmoji,
    emojiPositions
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_2__.useSticker)(pushMessage, channel, ctx, otherProps);
  const canvasStyle = {
    position: 'absolute',
...
function useSticker(pushMessage, channel) {
  const [showEmoji, setShowEmoji] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [emojiPositions, setEmojiPositions] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [isEmojiEnabled, setIsEmojiEnabled] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const selectedEmojiRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const canvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const onHandleClick = () => {
    if (isEmojiEnabled) {
      disableEmoji();
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker, otherProps.showEmoji, otherProps.isCanvasClear, channel]);
