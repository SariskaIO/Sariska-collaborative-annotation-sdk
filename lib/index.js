...
const Canvas = _ref => {
  ...
  const emojiHook = (0,_hooks_useOnEmoji__WEBPACK_IMPORTED_MODULE_3__.useOnEmoji)(pushMessage, channel, setCanvasCtx, setAnnotations, otherProps);
  const circleHook = (0,_hooks_useOnCircle__WEBPACK_IMPORTED_MODULE_4__.useOnCircle)(pushMessage, channel, setCanvasCtx, annotations, otherProps);
  const drawHook = (0,_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_1__.useOnDraw)(pushMessage, channel, setCanvasCtx, setAnnotations, otherProps);
  console.log('annotartion', annotations);
...
function useOnCircle(pushMessage, channel, setCanvasCtx, annotations, otherProps) {
...
function useOnDraw(pushMessage, channel, setCanvasCtx, otherProps, setAnnotations) {
...
function useOnEmoji(pushMessage, channel, setCanvasCtx, otherProps, setAnnotations) {
