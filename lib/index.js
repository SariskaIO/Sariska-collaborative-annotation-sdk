...
const App = props => {
  ...
  const rtcChannel = (0,_channel_CreateChannel__WEBPACK_IMPORTED_MODULE_3__["default"])(`rtc:${roomName}`, {});
  ...
  (0,_hooks_UseEventHandler__WEBPACK_IMPORTED_MODULE_4__["default"])(rtcChannel, 'new_message', setLoading, message => {
    ...
    if (content.type === 'emoji' && content.position) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_10__.onSticker)({
        ctx: canvasCtx,
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_useSticker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../hooks/useSticker */ "./src/hooks/useSticker.js");
/* harmony import */ var _hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../hooks/useOnDraw */ "./src/hooks/useOnDraw.js");
...
const Canvas = _ref => {
  ...
  const {
    ...
    onMouseDown,
    handleDraw
  } = (0,_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_2__.useOnDraw)(pushMessage, channel, setCanvasCtx, otherProps);
  ...
  const {
    ...
    setSelectedEmoji
    // onMouseClick,
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_1__.useSticker)(pushMessage, channel, setCanvasCtx, otherProps);

  // Use setStickerCanvasRef to set the canvas reference
  const ref = ref => {
    if (_hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_2__.useOnDraw) {
      setCanvasRef(ref);
    } else {
...
/* harmony import */ var _hooks_useOnDraw__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../hooks/useOnDraw */ "./src/hooks/useOnDraw.js");
// import React, { useState } from 'react'
// import { useStore } from '../../store';
...
const DrawingBoard = _ref => {
  ...
  const {
    ...
    selectedEmoji,
    setSelectedEmoji
  } = (0,_hooks_useSticker__WEBPACK_IMPORTED_MODULE_1__.useSticker)(pushMessage, channel, setCanvasCtx, inputProps);
...
function useOnDraw(pushMessage, channel, setCanvasCtx, otherProps) {
  ...
  }, [_utils__WEBPACK_IMPORTED_MODULE_1__.onDraw, channel, otherProps.isCanvasClear, otherProps.isImageSaved, otherProps.lineColor]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useSticker: () => (/* binding */ useSticker)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./src/utils/index.js");
...
function useSticker(pushMessage, channel, setCanvasCtx, otherProps) {
  const [emoji, setEmoji] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [positions, setPositions] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [selectedEmoji, setSelectedEmoji] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("😊");
  const canvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const prevPointRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const isStickRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
  const toggleEmoji = () => {
    setEmoji(prev => !prev);
  };
  const handleClick = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(e => {
    ...
    if (!emoji && canvasRef.current && e.target === canvasRef.current) {
      const newEmojiPosition = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.computePointInCanvas)(e.clientX, e.clientY, canvasRef.current);
      ...
      if (_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__.onSticker)(stickerData);
  ...
  }, [emoji, selectedEmoji, otherProps, _utils__WEBPACK_IMPORTED_MODULE_1__.onSticker, channel, setCanvasCtx]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
  ...
  const setStickerCanvasRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(ref => {
    if (!ref) return;
    canvasRef.current = ref;
  }, []);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
...
/* harmony export */   onSticker: () => (/* binding */ onSticker),
/* harmony export */   pasteSticker: () => (/* binding */ pasteSticker),
...
function onDraw(data) {
  drawLine(data.ctx, data.point, data.prevPoint, data.props ? data.props.lineColor : undefined, data.props ? data.props.lineWidth : undefined);
}
function pasteSticker(ctx, sticker, position) {
